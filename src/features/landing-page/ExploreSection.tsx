        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-6 sm:p-10 md:p-12 bg-gradient-to-br from-[#1161C2] via-[#1062b0] to-[#7A1FA2] text-white flex items-center">
            <div className="space-y-5 sm:space-y-6 max-w-xl">
              ...
              <Link
                href="/projects"
                className="inline-flex items-center bg-white text-slate-900 hover:bg-slate-100 px-5 sm:px-6 py-2.5 rounded-lg font-medium shadow-md transition-colors group text-sm sm:text-md"
              >
                Explore Our Story
