            ...
            categories.map((category, index) => (
              ...
              >
                <Image
                  ...
                  onError={(e) => {
                    console.log('Image failed to load:', category.image, 'for category:', category.name);
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-between">
                  <div>
                    <h3 className="text-white text-2xl font-bold drop-shadow-md">{category.name.toUpperCase()}</h3>
                    <p className="text-white/90 mt-2 max-w-lg">{category.description || 'Explore our collection'}</p>
